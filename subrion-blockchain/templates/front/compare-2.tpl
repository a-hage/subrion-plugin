...
<div id="{$blockchainCompare[$i].name}" class="block col-md-6 col-xs-6">
	...
	<div class="header-list">
		<div class="logos-info" data-compare="{$blockchainCompare[$i].name}" >
			<a href="{$blockchainCompare[$i].website}">
				<img class="img-fluid" title = "{$blockchainCompare[$i].name}" 
				alt="{$blockchainCompare[$i].name}" data-src="templates/kickstart/images/{strtolower($blockchainCompare[$i].name)}-logo.png" 
				src="templates/kickstart/images/{strtolower($blockchainCompare[$i].name)}-logo.png" widh="70px" height="70px"/>
			</a>
		</div>
		<h3>
			<a href="{$blockchainCompare[$i].website}" style="margin-top:20px; margin-left:20px;">
		...
		<a class="btn btn-primary btn-block btn-lg visit" href="{$blockchainCompare[$i].website}" target="_blank" style="width:100% !important;">Visit Website</a>
	</div>
	<!-- End Header-List -->
	<hr style="float:left;width:100%;">
	<!-- Begin Technical-Info -->
	<div class="technical-detail">
		<div class="header-info" style="margin-top:160px;">
			<h3>Overview</h3>
			{*  Symbol *}
